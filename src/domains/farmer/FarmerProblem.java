  ...
  extends Problem
{
  ...
  public FarmerProblem()
  {
    ...
    super.setIntroduction("A farmer and his wolf, goat, and cabbage come to the edge of a river they wish to cross." +
            ...
            "if the goat is left with the cabbage, the goat will eat the cabbage."+
